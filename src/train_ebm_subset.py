...
from model.constant import CONFLICTS_LIST, ATTRIBUTE_LIST, ATTRIBUTE_NAME_LIST

def main(args):

    # data settings
    train_loader, val_loader, test_loader, label_dim, indexs = get_data_specific_subset(args)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--attr_name',type=str, default='cifar10',choices=ATTRIBUTE_NAME_LIST)
    parser.add_argument('--attr_positive',action='store_true', default=False)
