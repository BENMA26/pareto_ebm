...
def gen_image(args, model, im_neg, num_steps, sample=False):
    ...
    for i in range(num_steps):
        '''
        random noise of langevin dynamics
        '''
        im_noise.normal_()
        ...
        '''
        optimize step of energy gradient
        '''
        ...
        if i == num_steps - 1:
            ...
            im_neg_kl = im_neg_kl - args.step_lr * im_grad[:n]
